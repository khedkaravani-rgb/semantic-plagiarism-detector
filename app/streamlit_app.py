...
with _footer_col1:
    st.caption(f"🎓 Semantic Plagiarism Detection System · v{APP_VERSION} · Streamlit · [🐛 Report Bug / Feedback](https://github.com/Babin123456/semantic-plagiarism-detector/issues)")
with _footer_col2:
    if _latest_tag:
        st.markdown(
            version_check_widget_html(
